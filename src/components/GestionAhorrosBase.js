...
const GestionAhorrosBase = ({ showEliminar = true, showFiltros = false }) => {
    ...
    <div className="max-w-[900px] mx-auto mt-[110px] mb-5 p-5 bg-white shadow-md rounded-lg">
      ...
      {showFiltros && (
        <div className="mb-5 flex flex-wrap gap-4">
          <input type="text" placeholder="Filtrar por Grupo" className="p-2 border rounded" />
          <input type="text" placeholder="Filtrar por Usuario" className="p-2 border rounded" />
          ...
          <button className="py-2 px-4 bg-blue-500 hover:bg-blue-600 text-white rounded font-bold">
            Aplicar Filtros
          </button>
        </div>
      )}
...
export default GestionAhorrosBase;
